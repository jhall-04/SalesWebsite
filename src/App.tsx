...
const improvements = [
  [
    [
      "Optimizing the value proposition to clearly answer the Three Whys.",
      "Ensuring everyone within the company can articulate a consistent value proposition.",
      "Defining buyer pain points",
      "Producing quantifiable evidence to support claims about solution value",
    ],
    [
      "Strengthening the alignment between the value proposition and the company's strategic goals and market positioning.",
      "Ensuring the value proposition is consistently communicated across all sales and marketing channels.",
      "Utilizing customer and market feedback to continuously refine and adapt the value proposition.",
      "Integrating measurable outcomes and evidence to substantiate claims within the value proposition.",
    ],
  ],
  [
    [
      "Identifying and filling gaps in your current product offerings to meet market expectations.",
      "Ensuring that the offering aligns with the company’s value proposition.",
      "Regularly gathering and incorporating customer feedback to refine offerings.",
      "Implementing consistent processes for developing and launching offerings.",
    ],
    [
      "Enhancing the product development process to be more proactive and market-driven.",
      "Improving the alignment between the offerings and the advanced value proposition.",
      "Introducing innovative features and services to differentiate from competitors.",
      "Establishing comprehensive metrics to assess the success and impact of the offerings.",
    ],
  ],
  [
    [
      "Implementing a structured sales process that can be consistently followed across the team.",
      "Training sales representatives to align their efforts with the company’s value proposition and offerings.",
      "Utilizing customer feedback to improve sales methodologies and approaches.",
      "Setting challenging yet achievable sales targets (stretch goals) to drive performance and innovation.",
    ],
    [
      "Establishing a data-driven approach to track and analyze sales performance.",
      "Developing advanced sales training programs for employee skill enhancement.",
      "Implementing customer relationship strategies to maintain and deepen customer relationships.",
      "Investing in sophisticated CRM and sales automation tools.",
    ],
  ],
  [
    [
      "Improving market segmentation to better target potential customers.",
      "Enhancing branding efforts to establish a stronger market presence.",
      "Increasing collaboration between marketing and sales teams to ensure consistent messaging.",
      "Utilizing data analytics to measure and optimize marketing performance.",
    ],
    [
      "Enhancing the data analytics capabilities to better segment and target audiences.",
      "Creating more sophisticated and targeted marketing campaigns.",
      "Incorporating advanced marketing automation tools to increase efficiency and reach.",
      "Increasing collaboration between marketing and sales teams to ensure seamless execution.",
    ],
  ],
  [
    [
      "Standardizing and documenting delivery processes.",
      "Improving consistency in execution of delivery.",
      "Implementing training programs for employees focused on delivery.",
      "Gathering and using customer feedback to improve delivery standards.",
    ],
    [
      "Improving coordination between different departments during project delivery.",
      "Investing in advanced project management tools and methodologies.",
      "Establishing metrics for evaluating and improving delivery performance.",
      "Enhancing customer communication and support throughout the delivery phase.",
    ],
  ],
  [
    [
      "Implementing a Customer Relationship Management (CRM) system to track and manage customer interactions effectively.",
      "Investing in marketing automation tools to increase brand awareness and lead generation.",
      "Utilizing sales automation tools to streamline sales processes and improve efficiency.",
      "Developing a standardized process for technology adoption and integration across the company.",
    ],
    [
      "Implementing advanced data analytics to measure technology impact accurately.",
      "Integrating artificial intelligence (AI) for predictive insights and decision-making.",
      "Automating more complex and personalized customer interactions.",
      "Ensuring seamless integration between various technology platforms.",
    ],
  ],
];
...
// Calculates the results for a specific category
...
// Gets the improvements for a specific category
...
// Gets the current progression level
...
function App() {
  ...
  // Calculates the total score for the selected questions
  const calculateTotal = () => {
    ...
    if (page < questions.length / 5 - 1) {
      const next = [
        +questions[0 + (page + 1) * 5][1],
        +questions[1 + (page + 1) * 5][1],
        +questions[2 + (page + 1) * 5][1],
        +questions[3 + (page + 1) * 5][1],
        +questions[4 + (page + 1) * 5][1],
      ];
...
*/
  ...
  // Resets the result page dropdowns
  const resetReslut = () => {
    setAdvDropped(false);
  ...
  // Displays and hides the emerging information
  const dropEmerging = () => {
  ...
  // Displays and hides the basic information
  const dropBasic = () => {
  ...
  // Displays and hides the advanced information
  const dropAdv = () => {
  ...
  // Handles when a tile is clicked and shows the correct page at the bottom
      ...
      {!testing && (
        <div className="title-page">
          <div className="image-container">
            <img
              src="https://github.com/jhall-04/SalesWebsite/blob/master/src/assets/salespng.png?raw=true"
              alt="Sales Splash Page"
          ...
          <div className="title-div">
            <p className="title">
              {
                "The SalesSparx FUSE process is a systematic approach designed to enhance go-to-market (GTM) "
              }
              maturity and accelerate sales growth. The start of the process is
              maturity gap analysis to identify a company's strengths and
              weaknesses accross 6 key components:
            </p>
            <div className="categories-container">
              <p className="category">
                Value Proposition: This focuses on clearly communicating the
                unique benefits of a product or service to the target market.
              </p>
              <p className="category">
                Offering: This involves continually refining and improving the
                products or services based on customer feedback and market
                demands.
              </p>
              <p className="category">
                Marketing: This emphasizes crafting and executing data-driven
                marketing strategies to effectively reach and engage target
                audiences.
              </p>
              <p className="category">
                Sales: This component focuses on developing an efficient and
                scalable sales process leveraging data insights for enhanced
                performance.
              </p>
              <p className="category">
                Delivery: This ensures that the company's offerings are
                delivered consistently and reliably, meeting or exceeding
                customer expectations.
              </p>
              <p className="category">
                Enablement Technology: This includes adopting and optimizing
                advanced technologies to streamline operations and support
                strategic goals.
              </p>
            </div>
            <p className="title-footer">
              To learn more about how we can help you meet your growth goals,
              take our free online go-to-market readiness test below
            </p>
            <button className="start-button" onClick={startTesting}>
              Take the test
            </button>
          </div>
        </div>
        ...
        <div className="App">
          {page <= questions.length / 5 && (
            <header className="App-header">
              ...
              {page === questions.length / 5 && (
                <h1 className="App-header-txt">RESULTS</h1>
              )}
            </header>
          )}
          <div className="App-content">
            {page < questions.length / 5 && (
              <Question
                text={questions[0 + page * 5][0].toString()}
                onAnswerSelected={(answer) => handleAnswerSelection(0, answer)}
                selectedAnswer={selectedAnswers[0]}
              />
            )}
            {page < questions.length / 5 && (
              <Question
                text={questions[1 + page * 5][0].toString()}
                onAnswerSelected={(answer) => handleAnswerSelection(1, answer)}
                selectedAnswer={selectedAnswers[1]}
              />
            )}
            {page < questions.length / 5 && (
              <Question
                text={questions[2 + page * 5][0].toString()}
                onAnswerSelected={(answer) => handleAnswerSelection(2, answer)}
                selectedAnswer={selectedAnswers[2]}
              />
            )}
            {page < questions.length / 5 && (
              <Question
                text={questions[3 + page * 5][0].toString()}
                onAnswerSelected={(answer) => handleAnswerSelection(3, answer)}
                selectedAnswer={selectedAnswers[3]}
              />
            )}
            {page < questions.length / 5 && (
              <Question
                text={questions[4 + page * 5][0].toString()}
                onAnswerSelected={(answer) => handleAnswerSelection(4, answer)}
                selectedAnswer={selectedAnswers[4]}
              />
            )}
            {page < questions.length / 5 - 1 && (
              <button className="next-button" onClick={calculateTotal}>
                Next
              </button>
            )}
            {page === questions.length / 5 - 1 && (
              ...
              <div className="full-results">
                <div className="results-summary">
                  <h2 className="results-title">
                    Results are in! Here's how your company is progressing in
                    each category of Go-To-Market readiness
                  </h2>
                  ...
                  <div className="breakdown-container">
                    <div className="breakdown">
                      <div className="breakdown-text">
                        ...
                        <div className="breakdown-dropdown">
                          <p className="benchmark-description-title">
                            Emerging:
                          </p>
                          <button
                            className="dropdown-button"
                            onClick={dropEmerging}
                          >
                            {buttonTextEmg}
                          </button>
                        </div>
                        ...
                        <div className="breakdown-dropdown">
                          ...
                          <button className="dropdown-button" onClick={dropAdv}>
                            {buttonTextAdv}
                          </button>
                        </div>
                        {advDropped && (
                    ...
                    <div className="benchmark-buttons">
                      ...
                      <div className="summary-button-container">
                        <button className="return-button" onClick={showSummary}>
                          Show Summary
                        </button>
                      </div>
                    </div>
            ...
            {page > questions.length / 5 && (
              <div className="summary-page">
                ...
                <div>
                  The SalesSparx FUSE process is a systematic approach designed
                  to enhance go-to-market (GTM) maturity and accelerate sales
                  growth. The start of the process is a maturity gap analysis to
                  identify a company's strengths and weaknesses accross 6 key
                  components:
                </div>
                <div className="results-container">
                  <div className="results-tiles">
                ...
                <div>
                  Something about how based on our experience, we’ve identified
                  the most effective strategies for improving your score at each
                  level
                </div>
          ...
          {page < questions.length / 5 && (
            <div className="floating-block">
              <div className="percentage">
                {Math.round((page / (questions.length / 5)) * 100)}%
              </div>
              <progress
                className="progress"
                value={page}
